    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(max_length=128, verbose_name='Name')),
                ('date_created', models.DateTimeField(auto_now_add=True)),
                ('images', models.ManyToManyField(blank=True, help_text='Choose the Image content blocks that this block will use. (You may need to create some first).', to='apps.promotions.Image', null=True)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('handpickedproductlist_ptr', models.OneToOneField(parent_link=True,
                                                                   ...
                                                                   auto_created=True,
                                                                   primary_key=True,
                                                                   to='apps.promotions.HandPickedProductList',
        ...
        migrations.AddField(
            ...
            name='tabbed_block',
            field=models.ForeignKey(verbose_name='Tabbed Block', related_name='tabs', to='apps.promotions.TabbedBlock', on_delete=models.CASCADE),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='orderedproduct',
            name='list',
            field=models.ForeignKey(verbose_name='List', to='apps.promotions.HandPickedProductList', on_delete=models.CASCADE),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='orderedproduct',
        ...
        migrations.AddField(
            ...
            name='products',
            field=models.ManyToManyField(through='apps.promotions.OrderedProduct', blank=True, verbose_name='Products', to='catalogue.Product', null=True),
            preserve_default=True,
        ),
    ]
